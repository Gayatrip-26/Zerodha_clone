...
2. npm init ----------- This command is to initialize the express application (package.json file)
   npm init -y ---------This command to give default ans automatically .

3. npm i -D nodemon ---------- (-D means Dev dependency) This command to add nodemon on your json 
   file.
...
4. npm i express body-parser cors dotenv mongoose passport passport-local  passport-local-mongoose
   
1️⃣ Core Express & Middleware:
...
4️⃣ Authentication (Passport.js & Strategies):
